...
//
//   VAT0/VAT21 · All Inventory · ANY buyer -> /1.21
//   VAT0/VAT21 · B2B Only      · ANY buyer -> bare (Max Price is already
//                                             excl. VAT there)
//   Margin     · any           · ANY buyer -> bare
//
// The Invoice Price formula then adds the 21% back for a Dutch buyer and
// leaves it off for reverse-charge, which is what makes both land on the
// same real price.
export function getMemberWtbNetSalePrice(price, vatType, inventoryFilter) {
